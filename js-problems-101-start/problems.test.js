...
xdescribe('orderStringAlphabetically', () => {
  ...
  test('should order a phrase alphabetically', () => {
    expect(fns.orderStringAlphabetically('javascript is cool')).toEqual('aacciijlooprsstv')
  })
  test('should be case insensive', () => {
    expect(fns.orderStringAlphabetically('Testing Rocks')).toEqual('cegiknorsstt')
  })
})
